...
{
    internal class ThirdBuster1 : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            busterPlayer.thirdShot1Rectangle = Projectile.Hitbox;

            if (busterPlayer.thirdShotCollide)
            {
                Projectile.Kill();
            }
        ...
        public override void Kill(int timeLeft)
        {
            ...
            busterPlayer.thirdShot1Rectangle = null;
        }
