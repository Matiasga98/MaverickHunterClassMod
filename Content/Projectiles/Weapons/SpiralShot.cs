...
{
    internal class SpiralShot : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Projectile.ai[1] < 16f)
            {
                ...
                {
                    Projectile.NewProjectile(Projectile.InheritSource(Projectile), player.Center, Projectile.velocity, ModContent.ProjectileType<SpiralShot2>(), Projectile.damage, Projectile.knockBack, player.whoAmI, 0);
                }
                if (Projectile.ai[1] == 16f)
                {
                    Projectile.NewProjectile(Projectile.InheritSource(Projectile), player.Center, Projectile.velocity, ModContent.ProjectileType<SpiralShot2>(), Projectile.damage, Projectile.knockBack, player.whoAmI, 1);
                }
