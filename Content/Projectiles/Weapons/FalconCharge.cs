...
{
    internal class FalconCharge : ModProjectile
    {
                ...
                case AIState.Shooting:
                    {
                        ...
                        else
                        {
                            if (Main.myPlayer == Projectile.owner)
                            {
                                ...
                                Projectile.NewProjectile(Projectile.InheritSource(Projectile), newCenter, Projectile.velocity * 1.1f, ModContent.ProjectileType<FalconBusterShot>(), Projectile.damage + 30, Projectile.knockBack, Main.myPlayer);
                                busterPlayer.isCharging = false;
                                Projectile.Kill();
                            }
                        }
